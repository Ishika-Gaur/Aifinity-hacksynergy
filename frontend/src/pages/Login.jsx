...
export default function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      {/* Left — form, sticky so it stays in view */}
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label
                  ...
                  className="block text-sm font-medium text-[var(--color-text-h)]"
                >
                  Password
                </label>
                <a
      ...
      {/* Right — informative panel, not just empty color */}
        ...
        <div className="mx-auto max-w-sm">
          ...
          <div className="mt-10 rounded-xl border border-[var(--color-primary-100)] bg-white p-5">
            <p className="text-sm leading-relaxed text-[var(--color-text-muted)]">
              "I stopped guessing what to revise once I could actually see
              my mistakes mapped out."
            </p>
